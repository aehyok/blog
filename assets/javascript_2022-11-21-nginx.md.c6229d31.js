import{_ as n,o as a,c as s,N as e}from"./chunks/framework.294d0221.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2022-11-21-nginx.md","lastUpdated":1679782995000}'),l={name:"javascript/2022-11-21-nginx.md"},o=e(`<h2 id="查看nginx-安装目录" tabindex="-1">查看nginx 安装目录 <a class="header-anchor" href="#查看nginx-安装目录" aria-label="Permalink to &quot;查看nginx 安装目录&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">find / -name nginx.conf</span></span>
