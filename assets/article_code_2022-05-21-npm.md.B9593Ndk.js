import{_ as a,c as e,o as s,ag as o}from"./chunks/framework.mJdS8VI0.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"article/code/2022-05-21-npm.md","filePath":"article/code/2022-05-21-npm.md","lastUpdated":1751965989000}'),t={name:"article/code/2022-05-21-npm.md"};function r(p,n,i,d,c,h){return s(),e("div",null,n[0]||(n[0]=[o(`<h4 id="_1、安装-nodejs-则其中会包含-npm-安装完-nodejs-后" tabindex="-1">1、安装 nodejs 则其中会包含 npm，安装完 nodejs 后 <a class="header-anchor" href="#_1、安装-nodejs-则其中会包含-npm-安装完-nodejs-后" aria-label="Permalink to &quot;1、安装 nodejs 则其中会包含 npm，安装完 nodejs 后&quot;">​</a></h4><div class="language-javascript vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">    node </span><span style="--shiki-light:#D73A49;--shiki-dark:#F97583;">-</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">v  </span><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">// 查看nodejs安装是否成功，成功后会出现版本号</span></span>
