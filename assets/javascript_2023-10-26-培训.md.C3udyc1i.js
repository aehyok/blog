...
<span class="line"><span>    -v ~/.ssh/known_hosts:/etc/hosts \\</span></span>
<span class="line"><span>    -v /root/goploy/repository:/opt/goploy/repository \\</span></span>
<span class="line"><span>    gogo</span></span></code></pre></div><h2 id="查看版本" tabindex="-1">查看版本 <a class="header-anchor" href="#查看版本" aria-label="Permalink to &quot;查看版本&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span> /usr/local/dotnet-sdk/dotnet --version</span></span></code></pre></div>`,48),i=[l];function t(o,c,d,r,h,u){return n(),a("div",null,i)}const v=s(e,[["render",t]]);export{b as __pageData,v as default};
