import{_ as s,o as a,c as n,b as e}from"./app.9a97ba65.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"创建数据库的命令","slug":"创建数据库的命令","link":"#创建数据库的命令","children":[]},{"level":2,"title":"nginx 配置的变更","slug":"nginx-配置的变更","link":"#nginx-配置的变更","children":[]},{"level":2,"title":"通过容器部署","slug":"通过容器部署","link":"#通过容器部署","children":[]},{"level":2,"title":"安装git","slug":"安装git","link":"#安装git","children":[]},{"level":2,"title":"mysql","slug":"mysql","link":"#mysql","children":[]}],"relativePath":"javascript/2023-11-16-webfunny.md","lastUpdated":1708739057000}'),l={name:"javascript/2023-11-16-webfunny.md"},p=e(`<h2 id="创建数据库的命令" tabindex="-1">创建数据库的命令 <a class="header-anchor" href="#创建数据库的命令" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#babed8;">CREATE DATABASE webfunny_db</span></span>
