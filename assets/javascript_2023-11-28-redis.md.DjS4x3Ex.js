import{_ as s,c as n,o as a,a3 as p}from"./chunks/framework.CaAmY9F2.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2023-11-28-redis.md","filePath":"javascript/2023-11-28-redis.md"}'),e={name:"javascript/2023-11-28-redis.md"},i=p(`<h2 id="docker下创建redis容器" tabindex="-1">docker下创建redis容器 <a class="header-anchor" href="#docker下创建redis容器" aria-label="Permalink to &quot;docker下创建redis容器&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>  // 查看redis镜像，找到Stars数量最多的</span></span>
...
<span class="line"><span>  redis-cli CONFIG SET requirepass 123456</span></span></code></pre></div>`,2),l=[i];function c(r,t,d,o,_,h){return a(),n("div",null,l)}const g=s(e,[["render",c]]);export{u as __pageData,g as default};
