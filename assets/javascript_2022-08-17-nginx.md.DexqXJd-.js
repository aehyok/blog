...
<span class="line"><span>}</span></span></code></pre></div><p>先来判断是在window执行的脚本，还是在mac下（linux应该也可以不过我没尝试过）两者获取路径的方式是不太一样。 然后其实就是通过scp指令，将本地打包编译好的目录，拷贝到服务器对应的目录上</p><h2 id="" tabindex="-1"><a class="header-anchor" href="#" aria-label="Permalink to &quot;&quot;">​</a></h2><ul><li></li></ul>`,22),i=[l];function t(c,o,r,d,h,g){return a(),s("div",null,i)}const b=n(e,[["render",t]]);export{x as __pageData,b as default};
