...
<span class="line"><span style="color:#A6ACCD;">		&quot;updatedAt&quot;: new Date(),</span></span>
<span class="line"><span style="color:#A6ACCD;">		&quot;updatedBy&quot;: ObjectId(&quot;617e957f64a6c3e07ad1bfb2&quot;), // Modify the ObjectId value as per your requirement</span></span>
<span class="line"><span style="color:#A6ACCD;">})</span></span></code></pre></div><h2 id="通过正则模糊查询" tabindex="-1">通过正则模糊查询 <a class="header-anchor" href="#通过正则模糊查询" aria-label="Permalink to &quot;通过正则模糊查询&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">db.models.find(</span></span>
<span class="line"><span style="color:#A6ACCD;">	{</span></span>
<span class="line"><span style="color:#A6ACCD;">		remark: {</span></span>
<span class="line"><span style="color:#A6ACCD;">			$regex: \`7\\\\.29\`,</span></span>
<span class="line"><span style="color:#A6ACCD;">			$options: &#39;ig&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;">		}</span></span>
<span class="line"><span style="color:#A6ACCD;">	}</span></span>
<span class="line"><span style="color:#A6ACCD;">)</span></span></code></pre></div>`,25),o=[p];function t(c,r,i,C,A,u){return a(),n("div",null,o)}const q=s(l,[["render",t]]);export{y as __pageData,q as default};
