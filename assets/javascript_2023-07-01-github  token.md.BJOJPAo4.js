...
<span class="line"><span>        run: docker push \${{ secrets.DOCKER_IMAGE_NAME }}:\${{env.IMAGE_TAG}}</span></span></code></pre></div>`,13),i=[t];function o(l,r,c,u,h,g){return a(),n("div",null,i)}const _=s(p,[["render",o]]);export{m as __pageData,_ as default};
