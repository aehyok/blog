import{_ as s,c as a,o as n,a5 as p}from"./chunks/framework.CW9jv5bj.js";const m=JSON.parse('{"title":"bind 127.0.0.1 -::1 将这一行暂时注释掉","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2023-12-28-ubuntu.md","filePath":"javascript/2023-12-28-ubuntu.md"}'),e={name:"javascript/2023-12-28-ubuntu.md"},l=p(`<h2 id="ubuntu说明" tabindex="-1">ubuntu说明 <a class="header-anchor" href="#ubuntu说明" aria-label="Permalink to &quot;ubuntu说明&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>//安装工具</span></span>
...
<span class="line"><span>chmod 777 run.sh</span></span></code></pre></div>`,37),i=[l];function t(c,r,o,d,u,h){return n(),a("div",null,i)}const g=s(e,[["render",t]]);export{m as __pageData,g as default};
