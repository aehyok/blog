import{_ as s,o as a,c as n,O as l}from"./chunks/framework.ce94e18e.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2023-05-24-docker-mysql.md","lastUpdated":1693311435000}'),e={name:"javascript/2023-05-24-docker-mysql.md"},p=l(`<h2 id="查看centos版本信息" tabindex="-1">查看centos版本信息 <a class="header-anchor" href="#查看centos版本信息" aria-label="Permalink to &quot;查看centos版本信息&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">cat /etc/centos-release</span></span>
