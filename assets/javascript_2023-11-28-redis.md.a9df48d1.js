import{_ as s,o as a,c as n,b as e}from"./app.39978e14.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"docker下创建redis容器","slug":"docker下创建redis容器","link":"#docker下创建redis容器","children":[]}],"relativePath":"javascript/2023-11-28-redis.md","lastUpdated":1710497801000}'),l={name:"javascript/2023-11-28-redis.md"},p=e(`<h2 id="docker下创建redis容器" tabindex="-1">docker下创建redis容器 <a class="header-anchor" href="#docker下创建redis容器" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#babed8;">  // 查看redis镜像，找到Stars数量最多的</span></span>
