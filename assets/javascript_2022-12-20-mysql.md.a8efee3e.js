import{_ as s,o as a,c as n,N as l}from"./chunks/framework.9e118f14.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2022-12-20-mysql.md","lastUpdated":1679683828000}'),p={name:"javascript/2022-12-20-mysql.md"},e=l(`<h2 id="登录mysql数据库" tabindex="-1">登录mysql数据库 <a class="header-anchor" href="#登录mysql数据库" aria-label="Permalink to &quot;登录mysql数据库&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// -h hostname mysql数据库服务器ip</span></span>
