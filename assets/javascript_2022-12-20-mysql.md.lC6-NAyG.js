import{_ as s,c as a,o as n,a3 as p}from"./chunks/framework.CaAmY9F2.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2022-12-20-mysql.md","filePath":"javascript/2022-12-20-mysql.md"}'),l={name:"javascript/2022-12-20-mysql.md"},e=p(`<h2 id="登录mysql数据库" tabindex="-1">登录mysql数据库 <a class="header-anchor" href="#登录mysql数据库" aria-label="Permalink to &quot;登录mysql数据库&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// -h hostname mysql数据库服务器ip</span></span>
...
<span class="line"><span>kill query id;</span></span></code></pre></div>`,15),t=[e];function i(c,o,r,d,u,h){return n(),a("div",null,t)}const b=s(l,[["render",i]]);export{g as __pageData,b as default};
