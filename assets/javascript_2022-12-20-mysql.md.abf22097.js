import{_ as s,o as a,c as n,b as l}from"./app.39978e14.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"登录mysql数据库","slug":"登录mysql数据库","link":"#登录mysql数据库","children":[]},{"level":2,"title":"查看文件大小","slug":"查看文件大小","link":"#查看文件大小","children":[]},{"level":2,"title":"导出表结构和数据库","slug":"导出表结构和数据库","link":"#导出表结构和数据库","children":[]},{"level":2,"title":"导入表结构和数据库","slug":"导入表结构和数据库","link":"#导入表结构和数据库","children":[]},{"level":2,"title":"mysql全量备份和增量备份","slug":"mysql全量备份和增量备份","link":"#mysql全量备份和增量备份","children":[]},{"level":2,"title":"查看mysql线程","slug":"查看mysql线程","link":"#查看mysql线程","children":[]}],"relativePath":"javascript/2022-12-20-mysql.md","lastUpdated":1710768133000}'),e={name:"javascript/2022-12-20-mysql.md"},p=l(`<h2 id="登录mysql数据库" tabindex="-1">登录mysql数据库 <a class="header-anchor" href="#登录mysql数据库" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#babed8;">// -h hostname mysql数据库服务器ip</span></span>
