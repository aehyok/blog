import{_ as s,o as n,c as a,N as p}from"./chunks/framework.294d0221.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2022-12-28-linux-h.md","lastUpdated":1680075991000}'),l={name:"javascript/2022-12-28-linux-h.md"},o=p(`<h2 id="dotnet-启动dll文件" tabindex="-1">dotnet 启动dll文件 <a class="header-anchor" href="#dotnet-启动dll文件" aria-label="Permalink to &quot;dotnet 启动dll文件&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">dotnet SLMDEngine.Base.dll --urls http://locaohost:8000</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="mysql-查看进程" tabindex="-1">mysql 查看进程 <a class="header-anchor" href="#mysql-查看进程" aria-label="Permalink to &quot;mysql 查看进程&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">数字乡村2.0打包机器 139.9.1.176  /home/soft  把编译好的文件拷贝到响应的目录下  执行 sh build.sh 2.2.0.005</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,4),e=[o];function c(t,A,C,r,i,y){return n(),a("div",null,e)}const d=s(l,[["render",c]]);export{m as __pageData,d as default};
