import{_ as a,c as n,o as p,ag as e}from"./chunks/framework.ELrfyV9R.js";const r=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"article/code/2022-08-18-commit.md","filePath":"article/code/2022-08-18-commit.md","lastUpdated":1776945928000}'),i={name:"article/code/2022-08-18-commit.md"};function t(l,s,c,o,u,d){return p(),n("div",null,s[0]||(s[0]=[e(`<h2 id="commit规范" tabindex="-1">commit规范 <a class="header-anchor" href="#commit规范" aria-label="Permalink to &quot;commit规范&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>pnpm i commitizen -D</span></span></code></pre></div><p>此时我们先 <code>git add .</code>,然后就可以使用一下 <code>git cz</code>,所以现在可以直接在package.json中添加一个scripts</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>&quot;git&quot;: &quot;git&quot;: &quot;git add . &amp;&amp; git cz&quot;</span></span></code></pre></div><p>那么接下来直接执行 <code>pnpm git</code></p><p><img src="https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/76d658108ab74a098fda2cc1c6bf574f~tplv-k3u1fbpfcp-watermark.image?" alt="image.png"></p><p>输入commit的提交信息，保存，关闭小窗，因为我这里用的是gitExtensions图形操作程序，随后git push提交即可，但是这样其实只是换了一个命令而已，并没有什么实质性的改变。</p><h2 id="cz-customizable设置提交模板" tabindex="-1">cz-customizable设置提交模板 <a class="header-anchor" href="#cz-customizable设置提交模板" aria-label="Permalink to &quot;cz-customizable设置提交模板&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>pnpm i cz-customizable</span></span></code></pre></div><p>安装完之后在package.json中添加如下节点</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span> &quot;config&quot;: {</span></span>
