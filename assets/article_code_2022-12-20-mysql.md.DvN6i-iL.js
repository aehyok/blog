import{_ as a,c as n,o as p,ag as l}from"./chunks/framework.mJdS8VI0.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"article/code/2022-12-20-mysql.md","filePath":"article/code/2022-12-20-mysql.md","lastUpdated":1753779437000}'),e={name:"article/code/2022-12-20-mysql.md"};function t(i,s,c,o,r,d){return p(),n("div",null,s[0]||(s[0]=[l(`<h2 id="登录mysql数据库" tabindex="-1">登录mysql数据库 <a class="header-anchor" href="#登录mysql数据库" aria-label="Permalink to &quot;登录mysql数据库&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>// -h hostname mysql数据库服务器ip</span></span>
