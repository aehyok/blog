import{_ as s,c as a,o as n,a3 as p}from"./chunks/framework.CaAmY9F2.js";const y=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2023-05-24-docker-mysql.md","filePath":"javascript/2023-05-24-docker-mysql.md"}'),e={name:"javascript/2023-05-24-docker-mysql.md"},l=p(`<h2 id="查看centos版本信息" tabindex="-1">查看centos版本信息 <a class="header-anchor" href="#查看centos版本信息" aria-label="Permalink to &quot;查看centos版本信息&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>cat /etc/centos-release</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>FLUSH PRIVILEGES;</span></span></code></pre></div>`,12),t=[l];function c(i,o,d,r,h,m){return n(),a("div",null,t)}const k=s(e,[["render",c]]);export{y as __pageData,k as default};
