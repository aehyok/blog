import{_ as s,o as n,c as a,N as l}from"./app.0f646e78.js";import"./chunks/theme.33468903.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"1、 reactive 定义 ts 数组","slug":"_1、-reactive-定义-ts-数组","link":"#_1、-reactive-定义-ts-数组","children":[]},{"level":2,"title":"2、 reactive 定义 ts 数组","slug":"_2、-reactive-定义-ts-数组","link":"#_2、-reactive-定义-ts-数组","children":[]},{"level":2,"title":"3、枚举的使用","slug":"_3、枚举的使用","link":"#_3、枚举的使用","children":[]},{"level":2,"title":"4、继承的使用","slug":"_4、继承的使用","link":"#_4、继承的使用","children":[]},{"level":2,"title":"5、创建一个 key,value 对象","slug":"_5、创建一个-key-value-对象","link":"#_5、创建一个-key-value-对象","children":[]},{"level":2,"title":"6、5 的升级玩法","slug":"_6、5-的升级玩法","link":"#_6、5-的升级玩法","children":[{"level":3,"title":"7、typescript中的枚举操作","slug":"_7、typescript中的枚举操作","link":"#_7、typescript中的枚举操作","children":[{"level":4,"title":"8、泛型函数和 箭头泛型函数","slug":"_8、泛型函数和-箭头泛型函数","link":"#_8、泛型函数和-箭头泛型函数","children":[]},{"level":4,"title":"7、通过type和interface 限制某个字符串变量的具体字符串","slug":"_7、通过type和interface-限制某个字符串变量的具体字符串","link":"#_7、通过type和interface-限制某个字符串变量的具体字符串","children":[]}]}]}],"relativePath":"javascript/2022-05-20-typescript.md","lastUpdated":1678577188000}'),p={name:"javascript/2022-05-20-typescript.md"},o=l(`<h2 id="_1、-reactive-定义-ts-数组" tabindex="-1">1、 reactive 定义 ts 数组 <a class="header-anchor" href="#_1、-reactive-定义-ts-数组" aria-hidden="true">#</a></h2><pre><code>\`\`\`javascript
...
<span class="line"></span></code></pre></div><h4 id="_8、泛型函数和-箭头泛型函数" tabindex="-1">8、泛型函数和 箭头泛型函数 <a class="header-anchor" href="#_8、泛型函数和-箭头泛型函数" aria-hidden="true">#</a></h4><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#C792EA;">function</span><span style="color:#A6ACCD;"> </span><span style="color:#82AAFF;">getUser</span><span style="color:#89DDFF;">&lt;</span><span style="color:#FFCB6B;">T</span><span style="color:#89DDFF;">&gt;(</span><span style="color:#A6ACCD;font-style:italic;">id</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;"> </span><span style="color:#FFCB6B;">string</span><span style="color:#89DDFF;">)</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"><span style="color:#F07178;">  }</span></span>
<span class="line"></span>
<span class="line"></span></code></pre></div><h4 id="_7、通过type和interface-限制某个字符串变量的具体字符串" tabindex="-1">7、通过type和interface 限制某个字符串变量的具体字符串 <a class="header-anchor" href="#_7、通过type和interface-限制某个字符串变量的具体字符串" aria-hidden="true">#</a></h4><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">  </span></span>
...
<span class="line"></span></code></pre></div>`,18),e=[o];function t(c,r,y,D,i,F){return n(),a("div",null,e)}const u=s(p,[["render",t]]);export{d as __pageData,u as default};
