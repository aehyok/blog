...
<span class="line"><span></span></span>
<span class="line"><span>ifconfig</span></span></code></pre></div><h2 id="centos-安装docker" tabindex="-1">centos 安装docker <a class="header-anchor" href="#centos-安装docker" aria-label="Permalink to &quot;centos 安装docker&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>yum install docker-ce -y</span></span></code></pre></div>`,55),i=[l];function t(o,r,c,d,u,h){return n(),s("div",null,i)}const m=a(p,[["render",t]]);export{b as __pageData,m as default};
