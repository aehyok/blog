...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">参数说明：</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">version: &#39;3&#39;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>docker exec consul_server_1 consul operator raft list-peers</p><p>docker exec consul_server_11 consul operator raft list-peers</p><p>server 有三个，client有一个</p><h2 id="安装nginx" tabindex="-1">安装nginx <a class="header-anchor" href="#安装nginx" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">apt-get install nginx</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">nginx -v</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>nginx config</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;"> server {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  }</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="dotnet-单文件部署" tabindex="-1">dotnet 单文件部署 <a class="header-anchor" href="#dotnet-单文件部署" aria-hidden="true">#</a></h2><ul><li><a href="https://www.cnblogs.com/ZaraNet/p/11790645.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/ZaraNet/p/11790645.html</a></li></ul><h2 id="安装dotnet-6-0-sdk" tabindex="-1">安装dotnet 6.0 sdk <a class="header-anchor" href="#安装dotnet-6-0-sdk" aria-hidden="true">#</a></h2><ul><li><a href="https://learn.microsoft.com/zh-cn/dotnet/core/install/linux-snap" target="_blank" rel="noreferrer">https://learn.microsoft.com/zh-cn/dotnet/core/install/linux-snap</a></li></ul><h2 id="dotnet-consul-demo" tabindex="-1">dotnet consul demo <a class="header-anchor" href="#dotnet-consul-demo" aria-hidden="true">#</a></h2><ul><li><p><a href="https://www.cnblogs.com/ansheng/p/16035028.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/ansheng/p/16035028.html</a></p></li><li><p><a href="https://www.cnblogs.com/wl-blog/p/15771111.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/wl-blog/p/15771111.html</a></p></li><li><p><a href="https://blog.csdn.net/wulex/article/details/122574103" target="_blank" rel="noreferrer">https://blog.csdn.net/wulex/article/details/122574103</a></p></li></ul><h2 id="dotnet-测试服务" tabindex="-1">dotnet 测试服务 <a class="header-anchor" href="#dotnet-测试服务" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">dotnet OcelotGateway.dll --urls=&quot;http://*:5003&quot;</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="dotnet项目中引用consul" tabindex="-1">dotnet项目中引用consul <a class="header-anchor" href="#dotnet项目中引用consul" aria-hidden="true">#</a></h2><ul><li><a href="https://www.cnblogs.com/rainingnight/p/servicediscovery-consul-in-asp-net-core.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/rainingnight/p/servicediscovery-consul-in-asp-net-core.html</a></li><li>fabio <ul><li><a href="https://github.com/fabiolb/fabio" target="_blank" rel="noreferrer">https://github.com/fabiolb/fabio</a></li><li>ubuntu <a href="https://www.cnblogs.com/xishuai/p/macos-and-ubuntu-install-fabio.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/xishuai/p/macos-and-ubuntu-install-fabio.html</a></li><li>docker fabio <a href="https://www.cnblogs.com/weirun/p/16466960.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/weirun/p/16466960.html</a></li></ul></li></ul><h2 id="consul-client-配置微服务接口配置-、邮件预警发送" tabindex="-1">consul client 配置微服务接口配置 、邮件预警发送 <a class="header-anchor" href="#consul-client-配置微服务接口配置-、邮件预警发送" aria-hidden="true">#</a></h2><ul><li>json文件 <a href="https://www.cnblogs.com/edisonchou/p/9148034.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/edisonchou/p/9148034.html</a></li></ul><h2 id="ocelot和consul-架构图" tabindex="-1">ocelot和consul 架构图 <a class="header-anchor" href="#ocelot和consul-架构图" aria-hidden="true">#</a></h2><ul><li><a href="https://www.cnblogs.com/PatrickLiu/p/14073192.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/PatrickLiu/p/14073192.html</a></li><li><a href="https://www.cnblogs.com/cheyunhua/p/15718331.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/cheyunhua/p/15718331.html</a></li></ul><h2 id="consul官网" tabindex="-1">consul官网 <a class="header-anchor" href="#consul官网" aria-hidden="true">#</a></h2><ul><li><a href="https://developer.hashicorp.com/consul/docs/intro" target="_blank" rel="noreferrer">https://developer.hashicorp.com/consul/docs/intro</a></li><li><a href="https://blog.51cto.com/wangguishe/5789295" target="_blank" rel="noreferrer">https://blog.51cto.com/wangguishe/5789295</a></li></ul>`,28),t=[o];function c(p,r,i,u,d,C){return n(),a("div",null,t)}const g=s(e,[["render",c]]);export{y as __pageData,g as default};
