import{_ as a,c as s,o as n,a5 as e}from"./chunks/framework.A9OIOolY.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2023-11-16-webfunny.md","filePath":"javascript/2023-11-16-webfunny.md"}'),p={name:"javascript/2023-11-16-webfunny.md"},i=e(`<h2 id="创建数据库的命令" tabindex="-1">创建数据库的命令 <a class="header-anchor" href="#创建数据库的命令" aria-label="Permalink to &quot;创建数据库的命令&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>CREATE DATABASE webfunny_db</span></span>
...
<span class="line"><span>show columns from Project;</span></span></code></pre></div>`,10),l=[i];function t(c,o,d,r,h,u){return n(),s("div",null,l)}const g=a(p,[["render",t]]);export{m as __pageData,g as default};
