import{_ as s,o as a,c as n,O as l}from"./chunks/framework.ce94e18e.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2022-12-20-mysql.md","lastUpdated":1690018982000}'),p={name:"javascript/2022-12-20-mysql.md"},e=l(`<h2 id="登录mysql数据库" tabindex="-1">登录mysql数据库 <a class="header-anchor" href="#登录mysql数据库" aria-label="Permalink to &quot;登录mysql数据库&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// -h hostname mysql数据库服务器ip</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">mysql -uroot -psunlight2010 metadata&lt;/usr/local/aehyok/CollectFormMetaData.sql</span></span></code></pre></div><h2 id="mysql全量备份和增量备份" tabindex="-1">mysql全量备份和增量备份 <a class="header-anchor" href="#mysql全量备份和增量备份" aria-label="Permalink to &quot;mysql全量备份和增量备份&quot;">​</a></h2><ul><li><a href="https://blog.csdn.net/weixin_51867896/article/details/123181512" target="_blank" rel="noreferrer">https://blog.csdn.net/weixin_51867896/article/details/123181512</a></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">参考如下：</span></span>
