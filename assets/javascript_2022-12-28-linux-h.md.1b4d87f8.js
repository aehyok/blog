import{_ as s,o as n,c as a,N as p}from"./app.0f646e78.js";import"./chunks/theme.33468903.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[{"level":2,"title":"dotnet 启动dll文件","slug":"dotnet-启动dll文件","link":"#dotnet-启动dll文件","children":[]},{"level":2,"title":"mysql 查看进程","slug":"mysql-查看进程","link":"#mysql-查看进程","children":[]}],"relativePath":"javascript/2022-12-28-linux-h.md","lastUpdated":1678577188000}'),l={name:"javascript/2022-12-28-linux-h.md"},e=p(`<h2 id="dotnet-启动dll文件" tabindex="-1">dotnet 启动dll文件 <a class="header-anchor" href="#dotnet-启动dll文件" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">dotnet SLMDEngine.Base.dll --urls http://locaohost:8000</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="mysql-查看进程" tabindex="-1">mysql 查看进程 <a class="header-anchor" href="#mysql-查看进程" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">数字乡村2.0打包机器 139.9.1.176  /home/soft  把编译好的文件拷贝到响应的目录下  执行 sh build.sh 2.2.0.005</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,4),o=[e];function c(t,A,C,r,i,y){return n(),a("div",null,o)}const h=s(l,[["render",c]]);export{d as __pageData,h as default};
