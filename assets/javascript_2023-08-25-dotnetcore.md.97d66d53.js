import{_ as s,o as a,c as n,O as l}from"./chunks/framework.ce94e18e.js";const D=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2023-08-25-dotnetcore.md","lastUpdated":1698238093000}'),e={name:"javascript/2023-08-25-dotnetcore.md"},p=l(`<h2 id="修改数据库的操作" tabindex="-1">修改数据库的操作 <a class="header-anchor" href="#修改数据库的操作" aria-label="Permalink to &quot;修改数据库的操作&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 生成实体变更</span></span>
...
<span class="line"><span style="color:#A6ACCD;">dotnet-ef database update</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">// 超过一个dbcontext就需要指定</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">dotnet-ef migrations add XXXX -c SecondContext</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">dotnet-ef migrations add XXXX -c DvsContext --framework net6.0</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">dotnet-ef database update  -c SecondContext</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">dotnet-ef database update  -c DvsContext --framework net6.0</span></span></code></pre></div><h2 id="api-nuget-ogr-v3-index-json无法访问是因为翻墙的问题" tabindex="-1">api.nuget.ogr/v3/index.json无法访问是因为翻墙的问题 <a class="header-anchor" href="#api-nuget-ogr-v3-index-json无法访问是因为翻墙的问题" aria-label="Permalink to &quot;api.nuget.ogr/v3/index.json无法访问是因为翻墙的问题&quot;">​</a></h2><p>更改为直连即可</p><h2 id="linux-服务位置" tabindex="-1">linux 服务位置 <a class="header-anchor" href="#linux-服务位置" aria-label="Permalink to &quot;linux 服务位置&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 自定义服务地址</span></span>
...
<span class="line"><span style="color:#A6ACCD;">SHOW DATABASES;</span></span></code></pre></div><h2 id="mysql执行数据同步时有可能有数据表访问权限的问题" tabindex="-1">mysql执行数据同步时有可能有数据表访问权限的问题 <a class="header-anchor" href="#mysql执行数据同步时有可能有数据表访问权限的问题" aria-label="Permalink to &quot;mysql执行数据同步时有可能有数据表访问权限的问题&quot;">​</a></h2><h2 id="判断枚举是否存在" tabindex="-1">判断枚举是否存在 <a class="header-anchor" href="#判断枚举是否存在" aria-label="Permalink to &quot;判断枚举是否存在&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">//if (!Enum.IsDefined(typeof(TaskType), model.TaskType))</span></span>
<span class="line"><span style="color:#A6ACCD;">            //{</span></span>
<span class="line"><span style="color:#A6ACCD;">            //    throw new ErrorCodeException(-1, &quot;传入的任务类型不存在&quot;);</span></span>
<span class="line"><span style="color:#A6ACCD;">            //}</span></span>
<span class="line"><span style="color:#A6ACCD;">            //else</span></span>
<span class="line"><span style="color:#A6ACCD;">            //{</span></span>
<span class="line"><span style="color:#A6ACCD;">            //    spec.Query.Where(item =&gt; item.TaskType == model.TaskType);</span></span>
<span class="line"><span style="color:#A6ACCD;">            //}</span></span></code></pre></div><h2 id="将efcore-idbcontexttransaction转换为-mysql驱动下-dbtransaction" tabindex="-1">将EFCore IDbContextTransaction转换为 Mysql驱动下 DbTransaction <a class="header-anchor" href="#将efcore-idbcontexttransaction转换为-mysql驱动下-dbtransaction" aria-label="Permalink to &quot;将EFCore IDbContextTransaction转换为 Mysql驱动下 DbTransaction&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">public static DbTransaction GetDbTransaction(this IDbContextTransaction source)</span></span>
<span class="line"><span style="color:#A6ACCD;">    {</span></span>
<span class="line"><span style="color:#A6ACCD;">        return (source as IInfrastructure&lt;DbTransaction&gt;).Instance;</span></span>
<span class="line"><span style="color:#A6ACCD;">    }</span></span></code></pre></div><h2 id="事务里面如果有创建表结构的则不会跟随事务" tabindex="-1">事务里面如果有创建表结构的则不会跟随事务 <a class="header-anchor" href="#事务里面如果有创建表结构的则不会跟随事务" aria-label="Permalink to &quot;事务里面如果有创建表结构的则不会跟随事务&quot;">​</a></h2>`,28),o=[p];function t(c,i,r,C,A,d){return a(),n("div",null,o)}const u=s(e,[["render",t]]);export{D as __pageData,u as default};
