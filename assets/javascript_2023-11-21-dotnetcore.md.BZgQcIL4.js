import{_ as s,c as n,o as a,a3 as p}from"./chunks/framework.CaAmY9F2.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2023-11-21-dotnetcore.md","filePath":"javascript/2023-11-21-dotnetcore.md"}'),e={name:"javascript/2023-11-21-dotnetcore.md"},l=p(`<h2 id="修改数据库的操作" tabindex="-1">修改数据库的操作 <a class="header-anchor" href="#修改数据库的操作" aria-label="Permalink to &quot;修改数据库的操作&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
...
<span class="line"><span>// 同时要将 ConnectionFactory.DispatchConsumersAsync 属性设置为 true</span></span></code></pre></div>`,43),i=[l];function t(c,o,d,r,u,h){return a(),n("div",null,i)}const m=s(e,[["render",t]]);export{b as __pageData,m as default};
