...
IF d_hlx=&#39;100B02002&#39; THEN
	 update pcs2309_tph_srqk t set t.zsrckfw = IFNULL(t.ncsr,0) + IFNULL(t.lpsr,0) - IFNULL(t.hgzfzc,0),
															...
															where t.hid=p_hid and t.nf=&#39;202309&#39;;
END IF;
</code></pre><p>#如果捕获到错误 IF t_error=1 THEN #回滚 ROLLBACK; ELSE #提交 COMMIT; END IF; END</p>`,7),r=[e];function U(n,_,s,d,c,p){return N(),L("div",null,r)}const a=t(F,[["render",U]]);export{E as __pageData,a as default};
