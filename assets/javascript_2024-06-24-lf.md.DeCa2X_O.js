...
<span class="line"><span>WantedBy=multi-user.target</span></span></code></pre></div><p>systemctl enable sun-xxm</p><p>systemctl start sun-xxm systemctl stop sun-xxm</p><p>journalctl -u sun-xxm.service -f</p><p>chmod -R 777 /root/dotnet6/</p><p>部署到服务器 tar -zxvf aspnetcore-runtime-6.0.3-linux-x64.tar.gz -C /usr/local/dotnet</p>`,14)]))}const x=n(e,[["render",l]]);export{m as __pageData,x as default};
