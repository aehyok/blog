...
<span class="line"><span style="color:#A6ACCD;">git commit </span><span style="color:#89DDFF;">--</span><span style="color:#A6ACCD;">no</span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">verify </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">m </span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;">xxx</span><span style="color:#89DDFF;">&#39;</span></span></code></pre></div></li><li>1.6、 设置远程仓库地址（即代码要提交到哪里的服务器）<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 当然也可以使用ssh 链接</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    git pull origin dev</span></span></code></pre></div></li><li>1.15、如果新装电脑后使用git 操作代码可能会报错<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 升级了OpenSSH 后报错</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    git stash push </span><span style="color:#89DDFF;">--</span><span style="color:#A6ACCD;">include</span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">untracked </span></span>
<span class="line"><span style="color:#89DDFF;">    </span><span style="color:#676E95;font-style:italic;">//或者简写</span></span>
<span class="line"><span style="color:#A6ACCD;">    git stash push </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">u</span></span></code></pre></div></li><li><p>5.3、恢复commit提交 // <a href="https://mp.weixin.qq.com/s/LDxXR302F9G35x3uwHh0jg" target="_blank" rel="noreferrer">https://mp.weixin.qq.com/s/LDxXR302F9G35x3uwHh0jg</a></p><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 最近一次的</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    git reset </span><span style="color:#89DDFF;">--</span><span style="color:#A6ACCD;">hard commitid</span></span></code></pre></div></li><li><p>5.4 如果是已经push的一个提交</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 该提交已经被push到远程服务器， 使用后将删除所有的更改</span></span>
<span class="line"><span style="color:#A6ACCD;">    git reset --hard HEAD~1</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">    // 然后使用强制推送</span></span>
<span class="line"><span style="color:#A6ACCD;">    git push -f</span></span></code></pre></div></li></ul><h2 id="_6、合并代码" tabindex="-1">6、合并代码 <a class="header-anchor" href="#_6、合并代码" aria-label="Permalink to &quot;6、合并代码&quot;">​</a></h2><ul><li><p>6.1、将远程分支代码合并到本地</p><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 先拉去远程分支代码，确保dev代码师最新的</span></span>
<span class="line"><span style="color:#A6ACCD;">    git checkout dev </span></span>
...
<span class="line"><span style="color:#A6ACCD;">    git push</span></span></code></pre></div></li><li><p>6.2、git subtree</p><ul><li><a href="https://juejin.cn/post/7018344866811740173" target="_blank" rel="noreferrer">https://juejin.cn/post/7018344866811740173</a></li><li><a href="https://segmentfault.com/a/1190000003969060" target="_blank" rel="noreferrer">https://segmentfault.com/a/1190000003969060</a></li></ul></li><li><p>6.3 免密登陆linux</p><ul><li><a href="https://juejin.cn/post/6844903734233792519" target="_blank" rel="noreferrer">https://juejin.cn/post/6844903734233792519</a><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">//本地生成就不说了在上面 </span></span>
<span class="line"><span style="color:#A6ACCD;">cat </span><span style="color:#89DDFF;">~/.</span><span style="color:#A6ACCD;">ssh</span><span style="color:#89DDFF;">/</span><span style="color:#A6ACCD;">id_rsa</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">pub </span><span style="color:#89DDFF;">|</span><span style="color:#A6ACCD;"> ssh root@</span><span style="color:#F78C6C;">139.159</span><span style="color:#89DDFF;">.</span><span style="color:#F78C6C;">245.209</span><span style="color:#A6ACCD;"> “cat </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&gt;&gt;</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">~/.</span><span style="color:#A6ACCD;">ssh</span><span style="color:#89DDFF;">/</span><span style="color:#A6ACCD;">authorized_keys”</span></span></code></pre></div></li></ul></li><li><p>6.4、Are you sure you want to continue connecting (yes/no/[fingerprint])?</p><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">vim </span><span style="color:#89DDFF;">~/.</span><span style="color:#A6ACCD;">ssh</span><span style="color:#89DDFF;">/</span><span style="color:#A6ACCD;">config</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">// 添加如下</span></span>
<span class="line"><span style="color:#A6ACCD;">StrictHostKeyChecking no</span></span></code></pre></div><ul><li><p><a href="https://stackoverflow.com/questions/64449495/how-to-accept-yes-from-shell-script-are-you-sure-you-want-to-continue-connect" target="_blank" rel="noreferrer">https://stackoverflow.com/questions/64449495/how-to-accept-yes-from-shell-script-are-you-sure-you-want-to-continue-connect</a></p></li><li><p><a href="https://stackoverflow.com/questions/63661505/git-always-prompts-are-you-sure-you-want-to-continue-connecting-yes-no-finger" target="_blank" rel="noreferrer">https://stackoverflow.com/questions/63661505/git-always-prompts-are-you-sure-you-want-to-continue-connecting-yes-no-finger</a></p></li></ul></li><li><p>6.5、两个git仓库进行代码和日志记录的合并</p><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// git@github.com:aehyok/blog1.git</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  git push</span></span></code></pre></div></li></ul><h2 id="_7、设置忽略文件" tabindex="-1">7、设置忽略文件 <a class="header-anchor" href="#_7、设置忽略文件" aria-label="Permalink to &quot;7、设置忽略文件&quot;">​</a></h2><ul><li><p>env文件设置忽略</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">//.gitignore文件中添加一行  </span></span>
<span class="line"><span style="color:#A6ACCD;">    .env.*</span></span>
<span class="line"><span style="color:#A6ACCD;">//在.gitignore文件中添加完之后，需要将git索引中的文件移除</span></span>
<span class="line"><span style="color:#A6ACCD;">    git rm --cached .env.*</span></span></code></pre></div></li><li><p>8、恢复文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// (如果还没有提交文件)撤销单个文件</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"> // 如果是多个文件的话</span></span>
<span class="line"><span style="color:#A6ACCD;"> git chekcout -- . </span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"> // 取消掉所有的更改</span></span>
<span class="line"><span style="color:#A6ACCD;"> git reset --hard</span></span></code></pre></div></li><li><p>9、设置git忽略</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 会匹配根目录下的 /server 目录，也会匹配任何子目录下的     </span></span>
<span class="line"><span style="color:#A6ACCD;"> server</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">  // 设置根目录下的server文件夹</span></span>
<span class="line"><span style="color:#A6ACCD;"> server/</span></span></code></pre></div></li></ul>`,15),t=[o];function e(c,i,r,y,C,D){return a(),n("div",null,t)}const F=s(p,[["render",e]]);export{g as __pageData,F as default};
