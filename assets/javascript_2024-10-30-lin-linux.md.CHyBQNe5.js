import{_ as s,c as a,o as n,a5 as p}from"./chunks/framework.CW9jv5bj.js";const k=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2024-10-30-lin-linux.md","filePath":"javascript/2024-10-30-lin-linux.md"}'),e={name:"javascript/2024-10-30-lin-linux.md"},o=p(`<h2 id="opencloudos通过yum安装docker-compose" tabindex="-1">opencloudos通过yum安装docker-compose <a class="header-anchor" href="#opencloudos通过yum安装docker-compose" aria-label="Permalink to &quot;opencloudos通过yum安装docker-compose&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>yum install docker-compose</span></span>
...
<span class="line"><span>docker rm mongo</span></span></code></pre></div><p>3001 root Lin2024!!! 放到sh文件中执行可能会报错，主要因为换行符不一致 可以使用如下命令 dos2unix del.sh</p>`,11),l=[o];function c(i,t,r,d,u,h){return n(),a("div",null,l)}const g=s(e,[["render",c]]);export{k as __pageData,g as default};
