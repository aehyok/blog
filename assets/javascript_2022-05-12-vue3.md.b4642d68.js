import{_ as s,o as n,c as a,N as l}from"./chunks/framework.8ca1de62.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2022-05-12-vue3.md","lastUpdated":1679159434000}'),p={name:"javascript/2022-05-12-vue3.md"},o=l(`<h3 id="_0、vue3中使用过的一些插件" tabindex="-1">0、vue3中使用过的一些插件 <a class="header-anchor" href="#_0、vue3中使用过的一些插件" aria-label="Permalink to &quot;0、vue3中使用过的一些插件&quot;">​</a></h3><ul><li>v-contextmenu 鼠标右键事件触发弹窗 <ul><li><a href="https://github.com/heynext/v-contextmenu" target="_blank" rel="noreferrer">https://github.com/heynext/v-contextmenu</a></li></ul></li><li>vuex-persistedstate 对vuex中的数据进行缓存处理（LocalStorage、SessionStorage） <ul><li><a href="https://github.com/robinvdvleuten/vuex-persistedstate" target="_blank" rel="noreferrer">https://github.com/robinvdvleuten/vuex-persistedstate</a></li></ul></li><li>treeSelect 下拉树控件 <ul><li><a href="https://github.com/megafetis/vue3-treeselect" target="_blank" rel="noreferrer">https://github.com/megafetis/vue3-treeselect</a></li></ul></li><li>swiper 轮播图最强插件 <ul><li><a href="https://github.com/nolimits4web/swiper" target="_blank" rel="noreferrer">https://github.com/nolimits4web/swiper</a></li></ul></li></ul><h2 id="_1、vue3-中-watch-详解" tabindex="-1">1、vue3 中 watch 详解 <a class="header-anchor" href="#_1、vue3-中-watch-详解" aria-label="Permalink to &quot;1、vue3 中 watch 详解&quot;">​</a></h2><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// watch 监控props中的值</span></span>
<span class="line"></span>
<span class="line"><span style="color:#676E95;font-style:italic;">/*</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">  immediate 默认值为 false,则第一次不会监听 watch 的执行</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">  immediate 设置为 true,则第一次也会监听 watch 的执行</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">  watch 位于子组件中时，子组件通过 v-if 和 v-show 控制显示时</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">*/</span></span>
...
<span class="line"><span style="color:#A6ACCD;">)</span><span style="color:#89DDFF;">;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#676E95;font-style:italic;">// watch 监控route路由中的值</span></span>
<span class="line"><span style="color:#82AAFF;">watch</span><span style="color:#A6ACCD;">(</span></span>
...
<span class="line"><span style="color:#A6ACCD;">)</span><span style="color:#89DDFF;">;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#676E95;font-style:italic;">// watch 监控vuex store仓库中的值</span></span>
<span class="line"><span style="color:#82AAFF;">watch</span><span style="color:#A6ACCD;">(</span></span>
...
<span class="line"><span style="color:#A6ACCD;">)</span><span style="color:#89DDFF;">;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#676E95;font-style:italic;">// watch 监控ref定义的值</span></span>
...
<span class="line"><span style="color:#A6ACCD;">)</span><span style="color:#89DDFF;">;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#676E95;font-style:italic;">// watch 监控reactive定义的值</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">// watch 监控ref定义的值</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#A6ACCD;">)</span><span style="color:#89DDFF;">;</span></span>
<span class="line"></span></code></pre></div><h2 id="_2、vue-3-全局函数或者全局变量注入" tabindex="-1">2、vue 3 全局函数或者全局变量注入 <a class="header-anchor" href="#_2、vue-3-全局函数或者全局变量注入" aria-label="Permalink to &quot;2、vue 3 全局函数或者全局变量注入&quot;">​</a></h2><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 全局函数注入</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#676E95;font-style:italic;">// 在组件中如何调用</span></span>
...
<span class="line"><span style="color:#676E95;font-style:italic;">// 开发环境中ctx和proxy都可以调用到函数</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">// 部署后发现ctx调用的函数为undefined，</span></span>
<span class="line"><span style="color:#676E95;font-style:italic;">/// 所以此处暂时用proxy代理，尤大支出少用proxy</span></span>
...
<span class="line"><span style="color:#F07178;">        </span><span style="color:#89DDFF;">}</span></span>
<span class="line"><span style="color:#F07178;">      </span><span style="color:#89DDFF;">}</span></span>
<span class="line"></span></code></pre></div><h2 id="_5、子组件中如何调用父组件中定义的函数通过-context-emit" tabindex="-1">5、子组件中如何调用父组件中定义的函数通过 context.emit <a class="header-anchor" href="#_5、子组件中如何调用父组件中定义的函数通过-context-emit" aria-label="Permalink to &quot;5、子组件中如何调用父组件中定义的函数通过 context.emit&quot;">​</a></h2><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"></span>
<span class="line"><span style="color:#89DDFF;">  </span><span style="color:#676E95;font-style:italic;">// 父组件中的代码</span></span>
<span class="line"><span style="color:#A6ACCD;">  </span><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">template</span><span style="color:#89DDFF;">&gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">        </span><span style="color:#82AAFF;">setup</span><span style="color:#A6ACCD;">()</span><span style="color:#89DDFF;">{</span></span>
<span class="line"><span style="color:#A6ACCD;">          const </span><span style="color:#F07178;">sayHello</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">(</span><span style="color:#A6ACCD;font-style:italic;">params</span><span style="color:#89DDFF;">)</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">{</span></span>
...
<span class="line"></span>
<span class="line"></span>
<span class="line"><span style="color:#676E95;font-style:italic;">// 子组件中的代码</span></span>
<span class="line"><span style="color:#89DDFF;">&lt;</span><span style="color:#F07178;">template</span><span style="color:#89DDFF;">&gt;</span></span>
...
<span class="line"><span style="color:#A6ACCD;">      context.emit(</span><span style="color:#89DDFF;">&quot;</span><span style="color:#F07178;">hello</span><span style="color:#89DDFF;">&quot;</span><span style="color:#89DDFF;">,</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&quot;</span><span style="color:#F07178;">hello 我时子组件</span><span style="color:#89DDFF;">&quot;</span><span style="color:#F07178;">)  </span><span style="color:#676E95;font-style:italic;">// 调用父组件方法</span></span>
...
<span class="line"></span></code></pre></div><h2 id="_6、vue2-中-sync-与子组件数据双向通信-用-vue3-中的-v-model-替换" tabindex="-1">6、vue2 中.sync 与子组件数据双向通信，用 vue3 中的 v-model 替换 <a class="header-anchor" href="#_6、vue2-中-sync-与子组件数据双向通信-用-vue3-中的-v-model-替换" aria-label="Permalink to &quot;6、vue2 中.sync 与子组件数据双向通信，用 vue3 中的 v-model 替换&quot;">​</a></h2><pre><code>\`\`\`javascript
...
\`\`\`
</code></pre><h2 id="defineexpose-将子组件方法或属性-暴露给父组件调用" tabindex="-1">defineExpose 将子组件方法或属性，暴露给父组件调用 <a class="header-anchor" href="#defineexpose-将子组件方法或属性-暴露给父组件调用" aria-label="Permalink to &quot;defineExpose 将子组件方法或属性，暴露给父组件调用&quot;">​</a></h2><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">   </span><span style="color:#676E95;font-style:italic;">// 子组件代码 child.vue</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#89DDFF;">   </span><span style="color:#676E95;font-style:italic;">// 在父组件中调用</span></span>
...
<span class="line"></span>
<span class="line"><span style="color:#89DDFF;">     </span><span style="color:#676E95;font-style:italic;">//达到调用子组件的属性和方法</span></span>
<span class="line"><span style="color:#A6ACCD;">     const </span><span style="color:#89DDFF;">{</span><span style="color:#A6ACCD;"> isFlag</span><span style="color:#89DDFF;">,</span><span style="color:#A6ACCD;"> testFunction</span><span style="color:#89DDFF;">}</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">=</span><span style="color:#A6ACCD;"> refChild</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">value</span></span>
<span class="line"><span style="color:#A6ACCD;">   </span><span style="color:#89DDFF;">}</span><span style="color:#A6ACCD;">)</span></span>
<span class="line"></span></code></pre></div><h2 id="vue3-keepalive-缓存" tabindex="-1">vue3 keepalive 缓存 <a class="header-anchor" href="#vue3-keepalive-缓存" aria-label="Permalink to &quot;vue3 keepalive 缓存&quot;">​</a></h2><pre><code>\`\`\`javascript
  https://juejin.cn/post/7018508057793691656
  页面第一次进入的时候，钩子触发顺序时created-&gt;mounted-&gt;activated，所以别在mounted和activated方法中写相同的逻辑代码

\`\`\`
</code></pre>`,21),e=[o];function t(c,r,D,y,F,i){return n(),a("div",null,e)}const u=s(p,[["render",t]]);export{A as __pageData,u as default};
