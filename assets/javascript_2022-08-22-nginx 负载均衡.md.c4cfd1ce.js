...
<span class="line"><span style="color:#A6ACCD;">    } </span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>部署完毕后，通过电脑查看，我没办法做测试，只能通过停掉91或者停掉92来访问90，都是没问题的。 那这里只好通过node开启后端服务来测试一下。</p><p>下面的代码算算是模拟91和92两个端口，相当于两台服务器，拷贝到linux服务器上，通过 node index.js运行起来</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">const http = require(&quot;http&quot;);</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">});</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>然后重新配置nginx-lb.conf，然后 <code>nginx -s reload</code></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">upstream nginxlbdemo{</span></span>
<span class="line"><span style="color:#A6ACCD;">    server 127.0.0.1:91;</span></span>
<span class="line"><span style="color:#A6ACCD;">    server 127.0.0.1:92;</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;">server {</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    server 127.0.0.1:92; </span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ul><li>热备 开始时只会访问91端口，如果91端口服务器发生故障，才会开启第二台服务器给提供服务。</li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">upstream nginxlbdemo{</span></span>
<span class="line"><span style="color:#A6ACCD;">    ip_hash;</span></span>
<span class="line"><span style="color:#A6ACCD;">    server 127.0.0.1:91;</span></span>
<span class="line"><span style="color:#A6ACCD;">    server 127.0.0.1:92 backup; </span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,18),o=[e];function t(c,r,i,C,A,y){return n(),a("div",null,o)}const g=s(p,[["render",t]]);export{u as __pageData,g as default};
