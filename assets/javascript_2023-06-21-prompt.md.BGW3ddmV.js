import{_ as a,c as s,o as n,a3 as p}from"./chunks/framework.CaAmY9F2.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2023-06-21-prompt.md","filePath":"javascript/2023-06-21-prompt.md"}'),e={name:"javascript/2023-06-21-prompt.md"},l=p(`<h2 id="处理邮件内容" tabindex="-1">处理邮件内容 <a class="header-anchor" href="#处理邮件内容" aria-label="Permalink to &quot;处理邮件内容&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>请将“《》”中间的无效内容去掉，并直接输出原来的内容文字即可，无需输出多余的文字 《-------------- 开始使用邮件 --------------------</span></span>
...
<span class="line"><span>})</span></span></code></pre></div>`,20),i=[l];function t(o,c,d,r,h,u){return n(),s("div",null,i)}const v=a(e,[["render",t]]);export{g as __pageData,v as default};
