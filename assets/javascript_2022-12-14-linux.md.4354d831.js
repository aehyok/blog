...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="查看cpu-内存" tabindex="-1">查看CPU 内存 <a class="header-anchor" href="#查看cpu-内存" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">查看系统整体的负载</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="查看cpu" tabindex="-1">查看CPU <a class="header-anchor" href="#查看cpu" aria-hidden="true">#</a></h2><ul><li>通过指令查看服务器进程的状态（CPU 和内存占用情况）<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">top</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>%us：表示用户进程的 CPU 使用时间（没有通过 nice 调度） %sy：表示系统进程的 CPU 使用时间，主要是内核使用。 %ni：表示用户进程中，通过 CPU 调度（nice）过的使用时间。 %id：空闲的 CPU 时间 %wa：CPU 运行时在等待 IO 的时间 %hi：CPU 处理硬中断花费的时间 %si：CPU 处理软中断花费的时间 %st：被虚拟机偷走的 CPU 时间</li></ul><p>参考 %us 的定义，对于 Linux 系统来说，MySQL 进程和它启动的所有线程都不算内核进程，因此 MySQL 的系统线程和用户线程在繁忙的时候，都会体现在 CPU 使用率的 %us 指标上。</p><ul><li>通过指令查看进程中的线程状态<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">top -Hp pid</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div></li></ul><h2 id="查看内存" tabindex="-1">查看内存 <a class="header-anchor" href="#查看内存" aria-hidden="true">#</a></h2><ul><li>free</li><li>free -m 查看多少MB</li><li>free -g 查看多少GB</li><li>查看内存占用前五的进程 <ul><li>ps auxw | head -1;ps auxw|sort -rn -k4|head -5</li></ul></li></ul><h2 id="查看文件-可以打印多个文件" tabindex="-1">查看文件（可以打印多个文件） <a class="header-anchor" href="#查看文件-可以打印多个文件" aria-hidden="true">#</a></h2><ul><li>cat file</li><li>head file // 开头的行数</li><li>head -n 5 file // 开头五行</li><li>tail file // 结尾的行数</li><li>tail -n 5 file // 结尾5行</li><li>wc -l file // 统计文件行数</li></ul><h2 id="登录mysql" tabindex="-1">登录mysql <a class="header-anchor" href="#登录mysql" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 登录mysql</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="mysql-备份" tabindex="-1">mysql 备份 <a class="header-anchor" href="#mysql-备份" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">如果是mariadb，可以用官方备份工具， </span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p><a href="https://www.modb.pro/db/454219" target="_blank" rel="noreferrer">https://www.modb.pro/db/454219</a><a href="https://www.cnblogs.com/liuxingke/articles/9216867.html" target="_blank" rel="noreferrer">https://www.cnblogs.com/liuxingke/articles/9216867.html</a></p><p>mysqldump -u USER -p test $(mysql -u USER -p -D test -Bse &quot;show tables like &#39;wiki_%&#39;&quot;)</p><h2 id="cron-周期性计划任务" tabindex="-1">cron 周期性计划任务 <a class="header-anchor" href="#cron-周期性计划任务" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 最小运行的单位是分钟级别 </span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="cron-ubuntu-安装" tabindex="-1">cron ubuntu 安装 <a class="header-anchor" href="#cron-ubuntu-安装" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">安装：apt-get install cron</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="系统服务所在的路径位置" tabindex="-1">系统服务所在的路径位置 <a class="header-anchor" href="#系统服务所在的路径位置" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 参考文章</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="查看systemctl-服务日志" tabindex="-1">查看systemctl 服务日志 <a class="header-anchor" href="#查看systemctl-服务日志" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 实时查看滚动日志</span></span>
<span class="line"><span style="color:#A6ACCD;">sudo journalctl -u dvs-collect -f</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="硬盘-分区-挂载" tabindex="-1">硬盘 分区 挂载 <a class="header-anchor" href="#硬盘-分区-挂载" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// lsblk  https://zhuanlan.zhihu.com/p/555993724</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="linux基础-变量" tabindex="-1">linux基础 变量 <a class="header-anchor" href="#linux基础-变量" aria-hidden="true">#</a></h2><ul><li><a href="https://blog.csdn.net/qq_35258036/article/details/123419703" target="_blank" rel="noreferrer">https://blog.csdn.net/qq_35258036/article/details/123419703</a></li></ul>`,35),c=[e];function o(t,i,r,C,A,y){return n(),a("div",null,c)}const u=s(p,[["render",o]]);export{h as __pageData,u as default};
