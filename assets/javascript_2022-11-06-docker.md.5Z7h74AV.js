...
<span class="line"><span>9、查看容器</span></span></code></pre></div><p>//列出容器 docker ps</p><p>// 列出所有容器（包括未运行的容器） docker ps -a</p><p>// 开启容器 (container id) docker start dsfsdfas</p><p>docker stop dfdssdf</p><p>// docker容器自启动</p><p>// 设置容器开机自动启动 docker update --restart=always xxxx</p><p>// 关闭容器开机自动启动 docker update --restart=no xxxx</p><p><a href="https://blog.csdn.net/m0_67392661/article/details/123732115" target="_blank" rel="noreferrer">https://blog.csdn.net/m0_67392661/article/details/123732115</a></p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
...
<span class="line"><span>    -  &lt;https://www.runoob.com/docker/docker-container-usage.html&gt;</span></span></code></pre></div>`,45),i=[t];function l(c,o,d,r,h,u){return n(),a("div",null,i)}const b=s(e,[["render",l]]);export{k as __pageData,b as default};
