...
<span class="line"></span>
<span class="line"></span></code></pre></div><h2 id="netstat-查看端口" tabindex="-1">netstat 查看端口 <a class="header-anchor" href="#netstat-查看端口" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">//列出所有端口情况，并根据findstr进行查询具体的端口使用情况</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">netstat -ano|findstr 3307</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ul><li><a href="https://juejin.cn/post/6844903605296726030" target="_blank" rel="noreferrer">https://juejin.cn/post/6844903605296726030</a></li></ul><h2 id="目录" tabindex="-1">目录 <a class="header-anchor" href="#目录" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 跳转到当前登录用户的主目录</span></span>
...
<span class="line"><span style="color:#A6ACCD;">cd -</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="拷贝文件-copy" tabindex="-1">拷贝文件(copy) <a class="header-anchor" href="#拷贝文件-copy" aria-hidden="true">#</a></h2><p>拷贝文件 aehyok-hard到 /usr/local/qiankun 目录下</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">cp aehyok-hard /usr/local/qiankun</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>当前目录下备份一个文件的话，或者叫复制一个文件的话</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">cp aehyok aehyok-bak</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>拷贝demo 目录下的所有文件到 /usr/local/qiankun 目录下</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">cp -R  demo /usr/local/qiankun/demo</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>备份当前目录下的一个文件夹，或者叫复制当前目录下的一个文件夹</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">cp - R demo /demo-bak</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="移动或更改文件或文件夹-move" tabindex="-1">移动或更改文件或文件夹（move） <a class="header-anchor" href="#移动或更改文件或文件夹-move" aria-hidden="true">#</a></h2><p>将当前目录下的文件名(文件夹名)修改为aehyok-bak</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">mv aehyok aehyok-bak</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>将当前目录下的aehyok-bake文件移动到~/demo-bak文件夹下</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">mv aehyok-bake ~/demo_bak</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="查看某个文件" tabindex="-1">查看某个文件 <a class="header-anchor" href="#查看某个文件" aria-hidden="true">#</a></h2><p>查看当前目录下的aehyok文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">cat aehyok</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>查看当前目录下的aheyok文件，并添加行号(以下两个命令都可以添加行号)</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">cat aehyok --number</span></span>
<span class="line"><span style="color:#A6ACCD;">cat -b aehyok</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>一起查看多个文件(同样可以添加行号)</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">cat aehyok aehyok-hard</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>将两个文件一起写入到新文件(如果原文件存在会覆盖)</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">cat aehyok aehyok-hard &gt; aehyok-new</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>将两个文件一起追加到新文件中</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">cat aehyok aehyok-hard&gt;&gt; aehyok-new</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="创建一个目录" tabindex="-1">创建一个目录 <a class="header-anchor" href="#创建一个目录" aria-hidden="true">#</a></h2><p>创建单个目录</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">mkdir aehyok</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>创建多级目录</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 如果两个目录都不存在则创建不了，需要使用-p命令</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>// 创建多级目录并查看创建过程</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">mkdir -pv aehyok1/aehyok2</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="创建文件" tabindex="-1">创建文件 <a class="header-anchor" href="#创建文件" aria-hidden="true">#</a></h2><p>创建一个文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">touch aehyok.txt</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>同时创建两个文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">touch aehyok2.txt aehyok1.txt</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="删除文件和文件夹" tabindex="-1">删除文件和文件夹 <a class="header-anchor" href="#删除文件和文件夹" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">- -f,--force 不提醒直接删除</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>删除一个指定的文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">rm aehyok.txt</span></span>
<span class="line"><span style="color:#A6ACCD;">rm -r aehyok.txt</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>删除aehyok目录下的所有文件和目录，并保留aehyok</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">rm -rf aehyok</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>删除当前目录下的txt文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 删除前会询问</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>删除以aehyok开头的文件</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">rm -- aehyok</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,54),o=[e];function t(c,r,i,y,C,D){return n(),a("div",null,o)}const h=s(p,[["render",t]]);export{F as __pageData,h as default};
