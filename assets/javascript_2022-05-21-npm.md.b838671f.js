import{_ as n,o as a,c as e,N as s}from"./chunks/framework.294d0221.js";const _=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2022-05-21-npm.md","lastUpdated":1680936558000}'),o={name:"javascript/2022-05-21-npm.md"},r=s(`<h4 id="_1、安装-nodejs-则其中会包含-npm-安装完-nodejs-后" tabindex="-1">1、安装 nodejs 则其中会包含 npm，安装完 nodejs 后 <a class="header-anchor" href="#_1、安装-nodejs-则其中会包含-npm-安装完-nodejs-后" aria-label="Permalink to &quot;1、安装 nodejs 则其中会包含 npm，安装完 nodejs 后&quot;">​</a></h4><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">node </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">v  </span><span style="color:#676E95;font-style:italic;">// 查看nodejs安装是否成功，成功后会出现版本号</span></span>
