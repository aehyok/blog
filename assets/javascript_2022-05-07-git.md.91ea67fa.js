...
<span class="line"><span style="color:#A6ACCD;">cat </span><span style="color:#89DDFF;">~/.</span><span style="color:#A6ACCD;">ssh</span><span style="color:#89DDFF;">/</span><span style="color:#A6ACCD;">id_rsa</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">pub</span></span>
<span class="line"></span></code></pre></div></li><li>1.2、 git config 配置提交用户名和用户邮箱<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">git config </span><span style="color:#89DDFF;">--</span><span style="color:#A6ACCD;">global user</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">name </span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">aehyok</span><span style="color:#89DDFF;">&quot;</span></span>
<span class="line"><span style="color:#A6ACCD;">git config </span><span style="color:#89DDFF;">--</span><span style="color:#A6ACCD;">global user</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">email </span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">aehyok@163.com</span><span style="color:#89DDFF;">&quot;</span></span>
<span class="line"></span>
<span class="line"><span style="color:#676E95;font-style:italic;">// 配置好后可通过这个来查看</span></span>
<span class="line"><span style="color:#A6ACCD;">git config </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">l</span></span>
<span class="line"></span></code></pre></div></li><li>1.3、 创建项目后如何提交到仓库<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 创建项目后到指定的项目文件夹中初始化git</span></span>
<span class="line"><span style="color:#A6ACCD;">git init</span></span>
<span class="line"></span></code></pre></div></li><li>1.4、 将文件添加到暂存区<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 将添加或修改的文件提交到暂存区</span></span>
...
<span class="line"><span style="color:#676E95;font-style:italic;">// 或者是</span></span>
<span class="line"><span style="color:#A6ACCD;">git add </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">A</span></span>
<span class="line"></span></code></pre></div></li><li>1.5、 提交到本地仓库（即自己当前电脑的代码仓库）<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 提交到本地仓库</span></span>
<span class="line"><span style="color:#A6ACCD;">git commit </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">m </span><span style="color:#89DDFF;">&#39;</span><span style="color:#C3E88D;"> feat: 初始化项目</span><span style="color:#89DDFF;">&#39;</span></span>
<span class="line"></span></code></pre></div></li><li>1.6、 设置远程仓库地址（即代码要提交到哪里的服务器）<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 当然也可以使用ssh 链接</span></span>
<span class="line"><span style="color:#A6ACCD;">git remote add github</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">origin </span><span style="color:#FFCB6B;">https</span><span style="color:#89DDFF;">:</span><span style="color:#676E95;font-style:italic;">//github.com/aehyok/demo.git</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#A6ACCD;">git push </span><span style="color:#89DDFF;">--</span><span style="color:#A6ACCD;">set</span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">upstream origin main</span></span>
...
<span class="line"><span style="color:#A6ACCD;">git config core</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">ignorecase </span><span style="color:#FF9CAC;">false</span></span>
<span class="line"></span></code></pre></div></li><li>1.9、修改文件夹名字大小写的问题<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// (修改前先将Test文件夹备份并修改为TestTemp&lt;一个临时文件夹名字而已&gt;,</span></span>
...
<span class="line"></span></code></pre></div></li><li>1.10、 是将远程主机的最新内容拉到本地 ,用户在检查了以后决定是否合并到工作本机分支中。<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">git fetch</span></span>
...
<span class="line"></span></code></pre></div></li><li>1.11、同样一个本地仓库可以设置多个远程仓库，然后通过不同的git push github.origin<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;"> </span><span style="color:#676E95;font-style:italic;">// 设置个github远程仓库</span></span>
<span class="line"><span style="color:#A6ACCD;"> git remote add github</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">origin </span><span style="color:#FFCB6B;">https</span><span style="color:#89DDFF;">:</span><span style="color:#676E95;font-style:italic;">//github.com/aehyok/demo.git</span></span>
<span class="line"></span>
<span class="line"><span style="color:#89DDFF;"> </span><span style="color:#676E95;font-style:italic;">// 设置个gitee远程仓库</span></span>
<span class="line"><span style="color:#A6ACCD;"> git remote add gitee</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">origin </span><span style="color:#FFCB6B;">https</span><span style="color:#89DDFF;">:</span><span style="color:#676E95;font-style:italic;">//github.com/aehyok/demo.git</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#A6ACCD;"> git remote rm gitee</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">origin</span></span>
<span class="line"></span></code></pre></div></li><li>1.12、克隆代码库<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;"> </span><span style="color:#676E95;font-style:italic;">// 目前没指定分支，默认为master</span></span>
<span class="line"><span style="color:#A6ACCD;"> git clone </span><span style="color:#FFCB6B;">https</span><span style="color:#89DDFF;">:</span><span style="color:#676E95;font-style:italic;">//github.com/aehyok/demo.git</span></span>
<span class="line"></span>
<span class="line"><span style="color:#89DDFF;"> </span><span style="color:#676E95;font-style:italic;">// 指定分支名称</span></span>
<span class="line"><span style="color:#A6ACCD;"> git clone </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">b dev  </span><span style="color:#FFCB6B;">https</span><span style="color:#89DDFF;">:</span><span style="color:#676E95;font-style:italic;">//github.com/aehyok/demo.git</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#A6ACCD;"> git clone gitee</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">origin  main</span></span>
<span class="line"></span></code></pre></div></li><li>1.13、git add . 时 vscode中警告 warning: LF will be replaced by CRLF in src/index.js.<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">    git config </span><span style="color:#89DDFF;">--</span><span style="color:#A6ACCD;">global core</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">autocrlf </span><span style="color:#FF9CAC;">false</span></span>
<span class="line"></span></code></pre></div></li><li>1.14、拉取远程分支代码到本地（拉取dev分支代码到本地的分支）<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">    git fetch origin dev</span></span>
<span class="line"><span style="color:#A6ACCD;">    </span></span>
<span class="line"><span style="color:#A6ACCD;">    git pull origin dev</span></span>
<span class="line"></span></code></pre></div></li><li>1.15、如果新装电脑后使用git 操作代码可能会报错<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">        </span><span style="color:#676E95;font-style:italic;">// 升级了OpenSSH 后报错</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    HostkeyAlgorithms </span><span style="color:#89DDFF;">+</span><span style="color:#A6ACCD;">ssh</span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">rsa</span></span>
<span class="line"><span style="color:#A6ACCD;">    PubkeyAcceptedKeyTypes </span><span style="color:#89DDFF;">+</span><span style="color:#A6ACCD;">ssh</span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">rsa      </span></span>
...
<span class="line"><span style="color:#A6ACCD;">git checkout </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">b dev</span></span>
<span class="line"></span></code></pre></div></li><li>2.2、 查看分支<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 查看本地分支</span></span>
...
<span class="line"></span></code></pre></div></li><li>2.3、 修改分支名称<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 修改当前本地分支的名称</span></span>
...
<span class="line"><span style="color:#A6ACCD;">git branch </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">m develop</span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">lam develop</span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">lqm</span></span>
<span class="line"></span></code></pre></div></li><li>2.4、 删除本地分支和删除远程分支<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 先切换到其他分支</span></span>
...
<span class="line"><span style="color:#A6ACCD;">git push origin </span><span style="color:#89DDFF;">--delete</span><span style="color:#A6ACCD;"> dev</span></span>
<span class="line"></span></code></pre></div></li></ul><h2 id="_3、合并代码" tabindex="-1">3、合并代码 <a class="header-anchor" href="#_3、合并代码" aria-label="Permalink to &quot;3、合并代码&quot;">​</a></h2><ul><li>3.1、 将某个提交，任何跟仓库所有分支的commit 合并到当前分支<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// (正常情况直接合并成功，可能存在重复图需要手动解决)</span></span>
...
<span class="line"></span></code></pre></div></li><li>3.2、 当前分支dev的代码提交push成功，此时想合并到main分支上<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">// 先切换到main分支</span></span>
<span class="line"><span style="color:#A6ACCD;">git checkout main</span></span>
<span class="line"></span>
...
<span class="line"></span></code></pre></div></li></ul><h2 id="_4、tag标签-根据tag标签创建的分支不要与标签名一致" tabindex="-1">4、tag标签(根据tag标签创建的分支不要与标签名一致) <a class="header-anchor" href="#_4、tag标签-根据tag标签创建的分支不要与标签名一致" aria-label="Permalink to &quot;4、tag标签(根据tag标签创建的分支不要与标签名一致)&quot;">​</a></h2><ul><li>4.1、添加一个tag，并推送到远程仓库<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">git tag </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">a </span><span style="color:#F78C6C;">3.11</span><span style="color:#89DDFF;">.</span><span style="color:#F78C6C;">3.001</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">m </span><span style="color:#89DDFF;">&quot;</span><span style="color:#C3E88D;">release 3.11.3.001</span><span style="color:#89DDFF;">&quot;</span></span>
<span class="line"><span style="color:#A6ACCD;">git push origin </span><span style="color:#F78C6C;">3.11</span><span style="color:#89DDFF;">.</span><span style="color:#F78C6C;">3.001</span></span>
<span class="line"></span></code></pre></div></li><li>4.2、 删除一个tag<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">git tag </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">d </span><span style="color:#F78C6C;">3.11</span><span style="color:#89DDFF;">.</span><span style="color:#F78C6C;">3.001</span></span>
<span class="line"><span style="color:#A6ACCD;">git push </span><span style="color:#FFCB6B;">origin</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;">refs</span><span style="color:#89DDFF;">/</span><span style="color:#A6ACCD;">tags</span><span style="color:#89DDFF;">/</span><span style="color:#F78C6C;">3.11</span><span style="color:#89DDFF;">.</span><span style="color:#F78C6C;">3.001</span></span>
<span class="line"></span></code></pre></div></li><li>4.3、 查看tag<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">git tag</span></span>
...
<span class="line"><span style="color:#A6ACCD;">git push origin test_tag　　　　</span><span style="color:#676E95;font-style:italic;">//!!!本地tag推送到线上</span></span>
<span class="line"></span></code></pre></div></li><li>4.5、 根据tag创建分支<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#FFCB6B;">https</span><span style="color:#89DDFF;">:</span><span style="color:#676E95;font-style:italic;">//www.cnblogs.com/senlinyang/p/9455426.html</span></span>
...
<span class="line"></span></code></pre></div></li><li>4.6、删除已经push到服务器的提交记录，到某个commitid<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#F78C6C;">1</span><span style="color:#A6ACCD;">、找到想要退回到的那个commitid</span></span>
<span class="line"><span style="color:#A6ACCD;">    git log </span></span>
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#F78C6C;">2</span><span style="color:#A6ACCD;">、然后将代码退回到那个commitid</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    </span><span style="color:#F78C6C;">3</span><span style="color:#A6ACCD;">、推送到服务器，已经要加上</span><span style="color:#89DDFF;">--</span><span style="color:#A6ACCD;">force</span></span>
<span class="line"><span style="color:#A6ACCD;">    git push origin </span><span style="color:#FFCB6B;">HEAD</span><span style="color:#89DDFF;">:</span><span style="color:#A6ACCD;">dev </span><span style="color:#89DDFF;">--</span><span style="color:#A6ACCD;">force</span></span>
<span class="line"></span></code></pre></div></li><li>4.7、删除没有push到远程服务器的commit记录<div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">     </span><span style="color:#F78C6C;">1</span><span style="color:#A6ACCD;">、通过找到想要退回到的commit_id</span></span>
<span class="line"><span style="color:#A6ACCD;">    git log </span></span>
<span class="line"><span style="color:#A6ACCD;">     </span><span style="color:#F78C6C;">2</span><span style="color:#A6ACCD;">、本地代码会变成你想要的那次代码。这次之后提交的代码都没有了</span></span>
...
<span class="line"><span style="color:#A6ACCD;">     </span><span style="color:#F78C6C;">3</span><span style="color:#A6ACCD;">、完成撤销，停留在当前版本，之前的代码还是在的。只是本地的提交记录没了</span></span>
<span class="line"><span style="color:#A6ACCD;">    git reset id </span></span>
<span class="line"></span></code></pre></div></li></ul><h2 id="_5、小技巧" tabindex="-1">5、小技巧 <a class="header-anchor" href="#_5、小技巧" aria-label="Permalink to &quot;5、小技巧&quot;">​</a></h2><ul><li><p>5.1、vscode中配置git bash 作为命令行</p><ul><li><a href="https://zhuanlan.zhihu.com/p/365625019" target="_blank" rel="noreferrer">https://zhuanlan.zhihu.com/p/365625019</a></li></ul></li><li><p>5.2、在某个分支暂存某些临时代码（不方便提交的）</p><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">    </span><span style="color:#676E95;font-style:italic;">// 将当前代码状态暂时切换WIP</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    </span></span>
<span class="line"></span></code></pre></div></li><li><p>5.3、恢复commit提交 // <a href="https://mp.weixin.qq.com/s/LDxXR302F9G35x3uwHh0jg" target="_blank" rel="noreferrer">https://mp.weixin.qq.com/s/LDxXR302F9G35x3uwHh0jg</a></p><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">    </span><span style="color:#676E95;font-style:italic;">// 最近一次的</span></span>
...
<span class="line"><span style="color:#A6ACCD;">    git reset </span><span style="color:#89DDFF;">--</span><span style="color:#A6ACCD;">hard commitid</span></span>
<span class="line"></span></code></pre></div></li></ul><h2 id="_6、合并代码" tabindex="-1">6、合并代码 <a class="header-anchor" href="#_6、合并代码" aria-label="Permalink to &quot;6、合并代码&quot;">​</a></h2><ul><li><p>6.1、将远程分支代码合并到本地</p><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">    </span><span style="color:#676E95;font-style:italic;">// 先拉去远程分支代码，确保dev代码师最新的</span></span>
<span class="line"><span style="color:#A6ACCD;">    git checkout dev </span></span>
...
<span class="line"><span style="color:#A6ACCD;">    git push </span></span>
<span class="line"></span></code></pre></div></li><li><p>6.2、git subtree</p><ul><li><a href="https://juejin.cn/post/7018344866811740173" target="_blank" rel="noreferrer">https://juejin.cn/post/7018344866811740173</a></li><li><a href="https://segmentfault.com/a/1190000003969060" target="_blank" rel="noreferrer">https://segmentfault.com/a/1190000003969060</a></li></ul></li><li><p>6.3 免密登陆linux</p><ul><li><a href="https://juejin.cn/post/6844903734233792519" target="_blank" rel="noreferrer">https://juejin.cn/post/6844903734233792519</a><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#676E95;font-style:italic;">//本地生成就不说了在上面 </span></span>
<span class="line"><span style="color:#A6ACCD;">cat </span><span style="color:#89DDFF;">~/.</span><span style="color:#A6ACCD;">ssh</span><span style="color:#89DDFF;">/</span><span style="color:#A6ACCD;">id_rsa</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">pub </span><span style="color:#89DDFF;">|</span><span style="color:#A6ACCD;"> ssh root@</span><span style="color:#F78C6C;">139.159</span><span style="color:#89DDFF;">.</span><span style="color:#F78C6C;">245.209</span><span style="color:#A6ACCD;"> “cat </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">&gt;&gt;</span><span style="color:#A6ACCD;"> </span><span style="color:#89DDFF;">~/.</span><span style="color:#A6ACCD;">ssh</span><span style="color:#89DDFF;">/</span><span style="color:#A6ACCD;">authorized_keys”</span></span>
<span class="line"></span></code></pre></div></li></ul></li><li><p>6.4、Are you sure you want to continue connecting (yes/no/[fingerprint])?</p><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">vim </span><span style="color:#89DDFF;">~/.</span><span style="color:#A6ACCD;">ssh</span><span style="color:#89DDFF;">/</span><span style="color:#A6ACCD;">config</span></span>
...
<span class="line"></span></code></pre></div><ul><li><p><a href="https://stackoverflow.com/questions/64449495/how-to-accept-yes-from-shell-script-are-you-sure-you-want-to-continue-connect" target="_blank" rel="noreferrer">https://stackoverflow.com/questions/64449495/how-to-accept-yes-from-shell-script-are-you-sure-you-want-to-continue-connect</a></p></li><li><p><a href="https://stackoverflow.com/questions/63661505/git-always-prompts-are-you-sure-you-want-to-continue-connecting-yes-no-finger" target="_blank" rel="noreferrer">https://stackoverflow.com/questions/63661505/git-always-prompts-are-you-sure-you-want-to-continue-connecting-yes-no-finger</a></p></li></ul></li><li><p>6.5、两个git仓库进行代码和日志记录的合并</p><div class="language-javascript"><button title="Copy Code" class="copy"></button><span class="lang">javascript</span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#89DDFF;">  </span><span style="color:#676E95;font-style:italic;">// git@github.com:aehyok/blog1.git</span></span>
...
<span class="line"><span style="color:#A6ACCD;">  git remote add blog2 git@github</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">com:aehyok</span><span style="color:#89DDFF;">/</span><span style="color:#A6ACCD;">blog2</span><span style="color:#89DDFF;">.</span><span style="color:#A6ACCD;">git</span></span>
<span class="line"></span>
<span class="line"><span style="color:#89DDFF;">  </span><span style="color:#676E95;font-style:italic;">//2.在blog1仓库下拉取数据到本仓库</span></span>
<span class="line"><span style="color:#A6ACCD;">  git fetch blog2</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#A6ACCD;">  git checkout </span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">b blog2main blog2</span><span style="color:#89DDFF;">/</span><span style="color:#A6ACCD;">main</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#A6ACCD;">  git merge blog2main </span><span style="color:#89DDFF;">--</span><span style="color:#A6ACCD;">allow</span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">unrelated</span><span style="color:#89DDFF;">-</span><span style="color:#A6ACCD;">histories</span></span>
<span class="line"></span>
...
<span class="line"><span style="color:#A6ACCD;">  git push</span></span>
<span class="line"></span></code></pre></div></li></ul>`,13),o=[t];function e(c,i,r,y,D,C){return a(),n("div",null,o)}const F=s(p,[["render",e]]);export{g as __pageData,F as default};
