...
<span class="line"><span style="color:#babed8;"></span></span>
<span class="line"><span style="color:#babed8;"></span></span>
<span class="line"><span style="color:#babed8;">## seq</span></span>
<span class="line"><span style="color:#babed8;"></span></span>
...
<span class="line"><span style="color:#babed8;"></span></span>
<span class="line"><span style="color:#babed8;">## git拉取项目</span></span>
<span class="line"><span style="color:#babed8;"></span></span></code></pre></div><p>cd /root</p><p>// 创建目录，并cd过去 mkdir github cd github</p><p>//克隆项目 git clone <a href="mailto:git@github.com" target="_blank" rel="noreferrer">git@github.com</a>:aehyok/NET8.0.git</p><p>//给脚本授权 chmod 777 <a href="http://run.sh" target="_blank" rel="noreferrer">run.sh</a></p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#babed8;"></span></span></code></pre></div>`,34),t=[p];function o(r,c,i,d,b,y){return a(),n("div",null,t)}const m=s(l,[["render",o]]);export{h as __pageData,m as default};
