import{_ as s,c as n,o as a,a5 as p}from"./chunks/framework.A9OIOolY.js";const v=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2022-08-22-nginx 负载均衡.md","filePath":"javascript/2022-08-22-nginx 负载均衡.md"}'),e={name:"javascript/2022-08-22-nginx 负载均衡.md"},l=p(`<ul><li>先上一个前端版本，同一份打包编译后的文件，分别部署到one和two.</li><li>因为我只有一台服务器，所以这里通过端口进行演示： one对应端口91，two对应端口92.</li><li>通过upstream nginxlbdemo进行负载配置.</li><li>最后通过proxy_pass反向代理 upstream.</li><li>如果有修改nginx的配置文件，修改完毕后记得 <code>nginx -s reload</code></li></ul><p>nginx-lb.conf</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>upstream nginxlbdemo{</span></span>
...
<span class="line"><span>}</span></span></code></pre></div>`,18),i=[l];function t(c,o,r,d,u,h){return a(),n("div",null,i)}const b=s(e,[["render",t]]);export{v as __pageData,b as default};
