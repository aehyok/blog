import{_ as i,c as a,o as n,ag as t}from"./chunks/framework.ELrfyV9R.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"article/code/2022-05-20-typescript.md","filePath":"article/code/2022-05-20-typescript.md","lastUpdated":1761788882000}'),e={name:"article/code/2022-05-20-typescript.md"};function l(h,s,p,k,r,d){return n(),a("div",null,s[0]||(s[0]=[t(`<h2 id="_1、-reactive-定义-ts-数组" tabindex="-1">1、 reactive 定义 ts 数组 <a class="header-anchor" href="#_1、-reactive-定义-ts-数组" aria-label="Permalink to &quot;1、 reactive 定义 ts 数组&quot;">​</a></h2><pre><code>\`\`\`javascript
