...
<span class="line"><span style="color:#A6ACCD;">systemctl start dvs-robot.service</span></span></code></pre></div><ul><li>nginx中添加前端项目</li></ul><p>前端项目nginx配置</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">location /robot{</span></span>
...
<span class="line"><span style="color:#A6ACCD;">        ...</span></span>
<span class="line"><span style="color:#A6ACCD;">    }</span></span>
<span class="line"><span style="color:#A6ACCD;">}</span></span></code></pre></div><p>三个服务承受负载的比重分别为：3:1:1</p>`,20),o=[e];function t(c,r,i,C,A,y){return n(),a("div",null,o)}const D=s(p,[["render",t]]);export{u as __pageData,D as default};
