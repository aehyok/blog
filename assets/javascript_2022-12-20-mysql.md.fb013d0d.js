...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="查看文件大小" tabindex="-1">查看文件大小 <a class="header-anchor" href="#查看文件大小" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">du -f</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="导出表结构和数据库" tabindex="-1">导出表结构和数据库 <a class="header-anchor" href="#导出表结构和数据库" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 只导出单个数据库的表结构</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="导入表结构和数据库" tabindex="-1">导入表结构和数据库 <a class="header-anchor" href="#导入表结构和数据库" aria-hidden="true">#</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">//假如备份的是多个数据库，可以直接执行</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="mysql全量备份和增量备份" tabindex="-1">mysql全量备份和增量备份 <a class="header-anchor" href="#mysql全量备份和增量备份" aria-hidden="true">#</a></h2><ul><li><a href="https://blog.csdn.net/weixin_51867896/article/details/123181512" target="_blank" rel="noreferrer">https://blog.csdn.net/weixin_51867896/article/details/123181512</a></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">参考如下：</span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><h2 id="查看mysql线程" tabindex="-1">查看mysql线程 <a class="header-anchor" href="#查看mysql线程" aria-hidden="true">#</a></h2><ul><li>kill 不掉线程的问题 <ul><li><a href="https://www.modb.pro/db/491961" target="_blank" rel="noreferrer">https://www.modb.pro/db/491961</a></li><li><a href="https://cloud.tencent.com/developer/article/1634259" target="_blank" rel="noreferrer">https://cloud.tencent.com/developer/article/1634259</a></li></ul></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight" tabindex="0"><code><span class="line"><span style="color:#A6ACCD;">// 在mysql 命令行中执行</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,15),t=[e];function o(c,i,r,C,A,d){return a(),n("div",null,t)}const D=s(p,[["render",o]]);export{h as __pageData,D as default};
