import{_ as a,c as s,o as n,a5 as p}from"./chunks/framework.A9OIOolY.js";const m=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2024-11-19.-自主填报配置sql.md","filePath":"javascript/2024-11-19.-自主填报配置sql.md"}'),l={name:"javascript/2024-11-19.-自主填报配置sql.md"},e=p(`<h2 id="自主填报配置sql算法注意事项" tabindex="-1">自主填报配置sql算法注意事项 <a class="header-anchor" href="#自主填报配置sql算法注意事项" aria-label="Permalink to &quot;自主填报配置sql算法注意事项&quot;">​</a></h2><ul><li>sql中可以使用的几个字段 <ul><li>userid</li><li>regionid</li><li>taskid</li><li>populationid</li></ul></li></ul><h2 id="例子" tabindex="-1">例子 <a class="header-anchor" href="#例子" aria-label="Permalink to &quot;例子&quot;">​</a></h2><ul><li>如下 id，是业务表的guid字段， taskid是业务表的关联taskid，其他字段则是业务表的字段 select UUID() id, @taskid taskid from User u where u=@userid</li></ul><h2 id="注意事项" tabindex="-1">注意事项 <a class="header-anchor" href="#注意事项" aria-label="Permalink to &quot;注意事项&quot;">​</a></h2><ul><li><p>要发布自主填报之后才可以写sql</p></li><li><p>保证必须有数据的</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>SELECT UUID() id, @taskid taskid, p.\`Name\` c1,CONCAT(hn.\`Name\`, h.HouseNumber) as c2,vp.Contact c3,p.IdCard c4  FROM  \`User\` u </span></span>
...
<span class="line"><span>WHERE u.Id = 1676431146113699840</span></span></code></pre></div>`,8),i=[e];function o(t,d,c,u,h,r){return n(),s("div",null,i)}const _=a(l,[["render",o]]);export{m as __pageData,_ as default};
