...
<span class="line"><span>-e MYSQL_ROOT_PASSWORD=123456 -d mysql</span></span></code></pre></div><h2 id="创建一个无密码的容器" tabindex="-1">创建一个无密码的容器 <a class="header-anchor" href="#创建一个无密码的容器" aria-label="Permalink to &quot;创建一个无密码的容器&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>docker stop mysql-原来的容器</span></span>
...
<span class="line"><span> 123456</span></span></code></pre></div><h2 id="查看容器日志" tabindex="-1">查看容器日志 <a class="header-anchor" href="#查看容器日志" aria-label="Permalink to &quot;查看容器日志&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>docker logs -f mysql</span></span>
<span class="line"><span></span></span>
<span class="line"><span>docker log mysql --tail 10 //最近10条日志记录</span></span></code></pre></div>`,11),t=[l];function i(c,o,r,d,h,m){return n(),a("div",null,t)}const k=s(p,[["render",i]]);export{u as __pageData,k as default};
