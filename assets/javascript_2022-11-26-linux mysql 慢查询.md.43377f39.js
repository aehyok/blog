import{_ as s,o as a,c as l,N as n}from"./chunks/framework.8ca1de62.js";const A=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"javascript/2022-11-26-linux mysql 慢查询.md","lastUpdated":1679060180000}'),e={name:"javascript/2022-11-26-linux mysql 慢查询.md"},p=n(`<ul><li><a href="https://juejin.cn/post/7165767441883398175" target="_blank" rel="noreferrer">https://juejin.cn/post/7165767441883398175</a></li></ul><h2 id="查看linux服务器状态" tabindex="-1">查看linux服务器状态 <a class="header-anchor" href="#查看linux服务器状态" aria-label="Permalink to &quot;查看linux服务器状态&quot;">​</a></h2><ul><li>通过指令查看服务器进程的状态（CPU 和内存占用情况）<div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">top</span></span>
...
<span class="line"><span style="color:#A6ACCD;">mysqldumpslow -S r -t 20 /usr/local/aehyok/ba52a9d7d924-slow.log</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><ul><li>清空慢查询日志，并恢复 <a href="https://blog.csdn.net/weixin_41275260/article/details/125461408" target="_blank" rel="noreferrer">https://blog.csdn.net/weixin_41275260/article/details/125461408</a></li></ul><p>mysql&gt; FLUSH LOGS; Query OK, 0 rows affected (0.01 sec)</p><ul><li>慢查询 日志查看 <a href="https://cloud.tencent.com/developer/article/2154418" target="_blank" rel="noreferrer">https://cloud.tencent.com/developer/article/2154418</a><a href="https://juejin.cn/post/7033623654416007181" target="_blank" rel="noreferrer">https://juejin.cn/post/7033623654416007181</a></li><li>查看mysql 线程列表 select * from PROCESSLIST w where w.USER=&#39;dvs&#39; and w.db=&#39;dvsdb30&#39; order by TIME desc;</li></ul><p>慢查询日志文件 删除成功后 flush logs重置成功</p><h2 id="mysql-最大链接数" tabindex="-1">mysql 最大链接数 <a class="header-anchor" href="#mysql-最大链接数" aria-label="Permalink to &quot;mysql 最大链接数&quot;">​</a></h2><ul><li><p><a href="https://juejin.cn/post/6844903876999512078#comment" target="_blank" rel="noreferrer">https://juejin.cn/post/6844903876999512078#comment</a></p></li><li><p>当前的链接数</p></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">show status like &#39;Thread%&#39;;</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div><p>mysqladmin -u root-p flush-logs</p><p>flush failed; error: &#39;Access denied; you need (at least one of) the RELOAD privilege(s) for this operation&#39;</p><h2 id="查看mysql线程" tabindex="-1">查看mysql线程 <a class="header-anchor" href="#查看mysql线程" aria-label="Permalink to &quot;查看mysql线程&quot;">​</a></h2><ul><li><a href="https://blog.csdn.net/qq_36551991/article/details/113665145" target="_blank" rel="noreferrer">https://blog.csdn.net/qq_36551991/article/details/113665145</a></li></ul><h2 id="order-by-null" tabindex="-1">order by null <a class="header-anchor" href="#order-by-null" aria-label="Permalink to &quot;order by null&quot;">​</a></h2><ul><li><a href="https://www.jianshu.com/p/16f827724e8c" target="_blank" rel="noreferrer">https://www.jianshu.com/p/16f827724e8c</a></li></ul><h2 id="mysql-group-by-性能优化" tabindex="-1">mysql group by 性能优化 <a class="header-anchor" href="#mysql-group-by-性能优化" aria-label="Permalink to &quot;mysql group by 性能优化&quot;">​</a></h2><ul><li><a href="https://juejin.cn/post/6844903696644440072" target="_blank" rel="noreferrer">https://juejin.cn/post/6844903696644440072</a></li></ul><h2 id="慢查询几个常用的指令" tabindex="-1">慢查询几个常用的指令 <a class="header-anchor" href="#慢查询几个常用的指令" aria-label="Permalink to &quot;慢查询几个常用的指令&quot;">​</a></h2><ul><li><a href="https://juejin.cn/post/6844904037888851976#heading-12" target="_blank" rel="noreferrer">https://juejin.cn/post/6844904037888851976#heading-12</a></li></ul><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">mysqldumpslow -s t -t 100 -g /data/mysql/slow.log</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">// 得到返回记录集最多的10条SQL：</span></span>
<span class="line"><span style="color:#A6ACCD;">mysqldumpslow -s r -t  10 /var/lib/mysql/695f5026f0f6-slow.log</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
...
<span class="line"><span style="color:#A6ACCD;">mysqldumpslow -s t -t 100 -g &quot;left join&quot; /var/lib/mysql/695f5026f0f6-slow.log</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span>
<span class="line"><span style="color:#A6ACCD;">也支持管道符命令</span></span>
<span class="line"><span style="color:#A6ACCD;">mysqldumpslow -s t -t 10 -g &quot;left join&quot; /var/lib/mysql/695f5026f0f6-slow.log | more //分页显示</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,27),o=[p];function t(r,i,c,C,y,u){return a(),l("div",null,o)}const h=s(e,[["render",t]]);export{A as __pageData,h as default};
