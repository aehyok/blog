    ...
    <div class="search-form">
      <div class="form-group">
        ...
        <select v-model="searchParams.proxy" @change="handleSelectionChange">
          ...
          <option value="0x21deaea5f00c23bfbdf1cc29a700c11e0ccaa8ff">PTGE31Cn1-(Price)-57.9%-$11,828</option>
          <option value="0xeffcc79a8572940cee2238b44eac89f2c48fda88">FirstOrder-(Price)-56.7%-$342,477</option>
