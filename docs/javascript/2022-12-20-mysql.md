...
// 导出所有以DAS_开头的表结构和数据(还可以压缩)
mysqldump -h192.168.0.104 -P4006  -uroot -psunlight2021 dvsdb30 $(mysql -uroot -psunlight2021 -D dvsdb30 -Bse "show tables like 'DAS_%'") >> /usr/local/sunlight/abc.sql
